...
func TestOpenAPIIncludesPilotHardeningRoutesAndSchemas(t *testing.T) {
	...
	requiredFragments := []string{
		...
		"/api/v1/rollout-executions/{id}/evidence-pack:",
		...
		"BrowserSessionInfo:",
		"BrowserSessionInfoListResponse:",
		"BrowserSessionInfoItemResponse:",
		"WebhookRegistration:",
		...
		"RolloutEvidencePackSummary:",
		"RolloutEvidencePack:",
		"RolloutEvidencePackItemResponse:",
		"Repository:",
...
func TestOpenAPIIntegrationAndDiagnosticsRoutesUseDocumentedResponseSchemas(t *testing.T) {
	...
	sections := []struct {
		...
		{
			path:   "/api/v1/rollout-executions/{id}/evidence-pack",
			method: "GET",
			fragments: []string{
				"name: id",
				"$ref: '#/components/schemas/RolloutEvidencePackItemResponse'",
				"$ref: '#/components/responses/UnauthorizedError'",
				"$ref: '#/components/responses/ForbiddenError'",
				"$ref: '#/components/responses/NotFoundError'",
			},
		...
		},
		{
			...
			method: "GET",
			fragments: []string{
				"$ref: '#/components/schemas/BrowserSessionInfoListResponse'",
				"name: user_id",
				"name: status",
				"name: limit",
				"name: offset",
		...
		{
			path:   "/api/v1/browser-sessions/{id}/revoke",
			method: "POST",
			fragments: []string{
				"name: id",
				"$ref: '#/components/schemas/BrowserSessionInfoItemResponse'",
				"$ref: '#/components/responses/UnauthorizedError'",
				"$ref: '#/components/responses/ForbiddenError'",
				"$ref: '#/components/responses/NotFoundError'",
			},
